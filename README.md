...
This is a filament dryer that can be found for cheap con Aliexpress, by word
salad brands like Kingroon and Keepang.  

I paid mine €27,48 after discounts and I bought it with the intention to build
a custom PCB for it with a better temperature sensor and an ESP32, sure to be
able to reuse the fan, heater, and other hardware like the bearing and rods to
make the filament roll when pulled by the printer.  

What I wasn't expecting is that the PCB would've been so simple to
...
+ Sensors:
  + SMD thermistor, likeli 10KΩ rated value, soldered in the middle of the heater  
